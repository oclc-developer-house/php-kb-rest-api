...
class ResourceTest extends PHPUnit_Framework_TestCase {
	...
	public function setup(){
		...
		Resource::$supportedAuthenticationMethods = array('HMAC', 'AccessToken');
	}
	public function testConstructorWithID() {
		$options = array(
			'accessToken' => 'tk_fakefake',
		...
		//make sure the authorization header is set right
		$this->assertAttributeEquals('Bearer tk_fakefake', 'auth_header', $resource);
